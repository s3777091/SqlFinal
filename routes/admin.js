...
router.get('/', async function (req, res, next) {
  try {
    ...
    res.render('admin/index', { title: 'Admin page', userInfo });
  } catch (error) {
...
router.get('/product', async function (req, res, next) {
  try {
    ...
    res.render('admin/productAdmin', { title: 'Admin page', userInfo });
  } catch (error) {
    return res.status(500).send({ message: error.message });
  }
})
...
router.get('/category', async (req, res, next) => {
  try {
    ...
    res.render('admin/categoryAdmin', { title: 'Admin page', userInfo });
  } catch (error) {
    return res.status(500).send({ message: error.message });
  }
})
...
router.get('/warehouse', async (req, res, next) => {
  try {
    ...
    res.render('admin/warehouseAdmin', { title: 'Admin page', userInfo });
  } catch (error) {
    return res.status(500).send({ message: error.message });
  }
})
...
router.get('/product/edit', async (req, res, next) => {
  try {
    ...
    return res.render('admin/manageProduct', { title: 'Admin page', product, userInfo });
  } catch (error) {
    return res.status(500).json({ message: error.message });
  }
})
...
router.get('/category/edit', async (req, res, next) => {
  try {
    ...
    return res.render('admin/manageCategory', { title: 'Admin page', category, userInfo });
  } catch (error) {
    return res.status(500).json({ message: error.message });
  }
})
...
router.get('/warehouse/edit', async (req, res, next) => {
  try {
    ...
    return res.render('admin/manageWarehouse', { title: 'Admin page', warehouse, userInfo });
  } catch (error) {
    return res.status(500).json({ message: error.message });
  }
})
